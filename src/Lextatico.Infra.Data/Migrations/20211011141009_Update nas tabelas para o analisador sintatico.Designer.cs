...
namespace Lextatico.Infra.Data.Migrations
{
    ...
    [Migration("20211011141009_Update nas tabelas para o analisador sintatico")]
    partial class Updatenastabelasparaoanalisadorsintatico
    {
            ...
            modelBuilder.Entity("Lextatico.Domain.Models.NonTerminalTokenRuleClause", b =>
                {
                    ...
                    b.Property<Guid>("IdNonTerminalTokenRule")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IdNonTerminalTokenRule");
            ...
            modelBuilder.Entity("Lextatico.Domain.Models.NonTerminalTokenRuleClause", b =>
                {
                    ...
                    b.HasOne("Lextatico.Domain.Models.NonTerminalTokenRule", "NonTerminalTokenRule")
                        .WithMany("NonTerminalTokenRuleClauses")
                        .HasForeignKey("IdNonTerminalTokenRule")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
